...
export function ExercisePicker({ onPick, onClose }: { onPick: (ex: Exercise) => void; onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex flex-col bg-[radial-gradient(circle_at_top,_rgba(37,99,235,0.18),_transparent_36%),#020617] max-w-md mx-auto border-x border-white/5 animate-in slide-in-from-bottom-full duration-300">
      <div className="flex items-center justify-between p-5 border-b border-white/5 bg-slate-950/80 backdrop-blur-2xl">
        <div>
      ...
      <div className="p-5 bg-slate-950/50">
        <div className="relative">
          ...
          <input
            ...
            className="w-full bg-slate-950/60 border border-blue-500/30 text-white rounded-2xl py-4 pl-11 pr-4 focus:outline-none focus:border-blue-500 transition-colors placeholder-slate-500 font-semibold"
          />
        </div>
      </div>

      <div className="flex-1 overflow-y-auto p-5 space-y-6 pt-0 hide-scrollbar">
